...
type interfaceOptionType = {
  ...
  basic: {
    ...
    choukaN: string,
    choukaFile: string,
    choukaTemplate: string,
    choukaOneResultTemplate: string,
...
function interfaceOption(value: Object, customProfiles: { command: string, text: string }[], choukaFile: string): interfaceOptionType{
  ...
  const inter: interfaceOption = {
    ...
    basic: {
      ...
      choukaFile,
      choukaTemplate: value.choukaTemplate,
      choukaOneResultTemplate: value.choukaOneResultTemplate,
